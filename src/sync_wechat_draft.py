...
def main() -> int:
    ...
    output_dir = PROJECT_ROOT / "outputs" / run_date
    ...
    notify_wechat_draft_created(run_date, title, media_id)
    return 0
...
def notify_wechat_draft_created(run_date: str, title: str, media_id: str) -> None:
